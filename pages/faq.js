                ...
                {selectedTab === 1 && (
                  <>
                    <QuestionItem header='1. ¿Cuál es el tipo de cambio para hoy?'>
                      <p>
                        El tipo de cambio para comprar es <b>{rates.buy}</b> y para vender es <b>{rates.sell}</b>
                      </p>
                    </QuestionItem>
                  ...
                  <>
                    <QuestionItem header='8. ¿Que son los KASH?'>
                      <p>
                        ...
                        <a href='https://app.instakash.net/register'>Regístrate</a> y comienza a ganar.
                      </p>
                    </QuestionItem>
