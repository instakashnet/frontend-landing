    ...
    <>
      ...
      <section className={styles.legal}>
        <div className="section-wrapper container px-3 py-12">
          ...
          <p>
            Para propósitos de las leyes asociadas a la Protección de Datos Personales, el controlador de la información es Instakash S.A.C. con RUC 20605285105, con domicilio en
            Av. Del Ejértico 749, Piso 2, Miraflores, Lima, Perú.
          </p>
          <p>
            ...
            identificar a esta persona. La información personal no incluye a la información que haya pasado por un proceso de anonimización y que por ende no puede ser utilizada
          ...
          <ol className="list-decimal pl-6">
            <li>
              ...
              la página web o reportar algún problema en la página web.
            </li>
            <li>
          ...
          <ol className="list-decimal pl-6">
            ...
            <li>
              Información que recibimos de otras fuentes: Nosotros podríamos recibir información acerca de usted si utiliza cualquier otra página web operada por nosotros o
              asociada a cualquier otro servicio provisto por nosotros. Nosotros también podríamos recibir información de los bancos u otras instituciones financieras utilizadas
              para transferir fondos. También trabajamos cercanamente con terceras partes (como agencias de historial crediticio, proveedores de análisis de datos, redes de
          ...
          <ol className="list-decimal pl-6">
            <li>
              ...
              <ul className="list-disc pl-6">
                ...
                <li>
                  Para el envío de anuncios y oferta de servicios por medio del correo electrónico registrado en la página web, envío de SMS y/o llamadas al número telefónico que
                  el Cliente ha registrado.
                </li>
                <li>
            ...
            <li>
              ...
              <ul className="list-disc pl-6">
                ...
                <li>
                  Para medir y entender la efectividad de la publicidad enviada a usted y a otros, con el fin de poder enviarle publicidad relevante y adecuada a sus intereses.
                  Para brindarle recomendaciones acerca de otros bienes y servicios que podrían interesarle.
                </li>
              </ul>
            </li>
            <li>
            ...
            <li>
              ...
              <ul className="list-disc pl-6">
                ...
                <li>
                  Si Instakash o todos sus activos son adquiridos por un tercero, en cuyo caso la información personal recolectada podría ser uno de los activos a transferir.
                </li>
                <li>
            ...
            <li>
              ...
              <p>
                Nosotros restringimos el acceso a su información personal a empleados de Instakash que tengan necesidad de conocerla por razones asociadas a los servicios
                brindados. Continuamente capacitamos a nuestros trabajadores sobre la importancia de la confidencialidad y privacidad de la información de los usuarios. Mantenemos
                procesos que cumplen con los requerimientos legales para proteger su información personal de cualquier acceso no autorizado.
              </p>
            </li>
            <li>
              <h3>Cookies</h3>
              ...
              <p>
                Los Cookies son pequeños ficheros de información que se almacenan en tu ordenador o dispositivo móvil. Esto es una práctica común en todos los sitios web. Las
                cookies no se usan para identificarte personalmente.
              </p>
              <p>La utilización de nuestro sitio web implica su aceptación del uso de cookies por nuestra parte.</p>
              <p>
                Recuerda que es posible desactivar las cookies almacenadas en su computadora cambiando la configuración de su navegador. Sin embargo, esto podría afectar el
                correcto funcionamiento de nuestra página web.
              </p>
            </li>
            <li>
              <h3>Sus derechos</h3>
          ...
          <p>
            ...
            costos asociados a brindarle dicha información. Cambios en la Política de privacidad.
          </p>

          <p>
            Cualquier cambio sustancial que se realice a nuestra Política de privacidad en el futuro será publicado en esta página y notificada a usted vía correo electrónico, de
            ser necesario. Se recomienda revisar frecuentemente esta página para ver cualquier actualización o cambios a nuestra Política de privacidad. Ley y Jurisdicción.
          </p>
