    ...
    <>
      ...
      <section className={styles.legal}>
        <div className='section-wrapper container px-3 pt-12'>
          ...
          <p className='mt-12'>
            El presente Acuerdo es un contrato entre usted e INSTAKASH S.A.C. (en adelante, “INSTAKASH”, o “la Empresa”) a efectos de hacer
            uso de los servicios brindados por nuestra empresa. Al registrarse, usted acepta todos los términos y condiciones establecidos
            en el presente contrato, lo que le permitirá utilizar los servicios de “INSTAKASH”. Por favor, lea este contrato detalladamente
            y asegúrese de entenderlo en su totalidad antes de utilizar los servicios. Tenga en cuenta que el utilizar los servicios
            prestados por INSTAKASH implica una aceptación de los términos de este Acuerdo. INSTAKASH no se hace responsable por la omisión
            o falta de lectura total o parcial de los Términos y Condiciones del uso de la plataforma.
          </p>
          <p className='my-3'>
          ...
          <p className='my-3'>
            INSTAKASH se reserva el derecho a modificar el presente Acuerdo de forma unilateral y sin previo aviso mediante la publicación
            de una nueva versión en el sitio web de la Empresa.
          </p>
          <ol className={styles.legalList}>
            ...
            <li>
              ...
              <p>
                EL USUARIO declara y garantiza que el usuario creado en LA PLATAFORMA de INSTAKASH, es para su uso personal y/o a nombre de
              ...
              <p>
                ...
                a: persona responsable de contacto para el registró y operación, información del representante legal e información
              ...
              <p>
                El USUARIO, al hacer uso de los servicios brindados por INSTAKASH se compromete a mantener actualizados los datos brindados,
                o actualizarlos cuando ello se requiera.
              </p>
              <p>
                Para hacer uso de nuestros servicios, el USUARIO debe ser mayor de 18 años de edad, y tener una cuenta bancaria en Soles
                (S/) y/o en Dólares ($) en un banco constituido en la República del Perú.
              </p>
            ...
            <li>
              ...
              <p>
                ...
                información adicional necesaria a fin de recabar la documentación correspondiente para dicho fin; de igual manera INSTAKASH
                se reserva el derecho de solicitar información a las entidades del Estado y/o privadas con el objeto de corroborar la
                veracidad de la información registrada al momento de abrir la cuenta.
              </p>
              <p>
                La Empresa se reserva el derecho a rechazar cualquier nuevo usuario o transferencia a discreción y sin expresión de causa
                ante la sospecha de que se estarían utilizando nuestras plataformas para realizar operaciones fraudulentas y/o delictivas.
              </p>
              <p>
                INSTAKASH se reserva el derecho de rechazar la apertura de cuentas respecto a personas cuya cuenta previamente haya sido
                dada de baja o suspendida”.
              </p>
              <p>
                En caso se detecten cuentas duplicadas, la Empresa se reserva el derecho a cerrar o fusionar las mismas, sin necesidad de
                dar previo aviso al titular de las cuentas.
              </p>
            </li>
            <li>
              ...
              <p>
                INSTAKASH solicitará el registro de la cuenta bancaria de origen y la cuenta bancaria destino del USUARIO con el fin de
                poder validar la autenticidad del titular de la cuenta.
              </p>

              <p>
                INSTAKASH no será responsable del bloqueo de cuentas bancarias registradas por el USUARIO en una entidad financiera o por
                otra situación similar a esta.
              </p>
              <p>
          ...
          <ol className={styles.legalList}>
            <li>
              ...
              <p>
                La moneda virtual KASH es un activo digital, emitido en asociación de KASHCORP SAC que custodia las transacciones vinculadas
                al KASH. Cada KASH que disponga el usuario corresponde a 1 dólar estadounidense en la cuenta bancaria para garantizar que
                siempre pueda comprar y canjear el activo con dólares estadounidenses vinculados 1:1.
              </p>
              <p>
                La moneda KASH es inmutable y transable de forma exclusiva dentro de la plataforma, ratificando así que no se puede emitir a
                discreción y tampoco destinar a fines ajenos a ésta. Constituye un patrimonio concreto en función de ofrecer estabilidad,
                comodidad, sencillez y sobre todo seguridad, ya que cada KASH tiene respaldo real (en dólares estadounidenses). En
                consecuencia, cada moneda KASH siempre estará disponible en forma de reserva.
              </p>
              <p>
            ...
            <li>
              ...
              <p>
                Para hacer uso de este servicio, el USUARIO debe contar con una cuenta bancaria propia en una entidad financiera supervisada
                por la SBS, es decir, debe aceptar realizar transferencias (en adelante, la “Cuenta de Cargo”) y, una cuenta bancaria propia
                para la recepción de fondos a través de entidades financieras (en adelante, la “Cuenta de Destino”).
              </p>
              <p>
                INSTAKASH no realiza ningún cobro de comisión por el uso de este servicio. Sin embargo, el USUARIO debe considerar que en
                determinados escenarios podrían existir cobros de comisiones o del impuesto a las transacciones financieras (ITF) por parte
                las entidades financieras involucradas en la operación.
              </p>
              ...
              <ul className='list-disc pl-6 mt-2'>
                ...
                <li>
                  INSTAKASH no realiza transferencias u operaciones a terceros. Es exigencia de la normativa de la SBS que el titular de la
                  cuenta de origen sea la misma persona natural o jurídica de la cuenta destino. De no coincidir alguna de éstas, deberá
                  proporcionar un número de cuenta con destino al titular de origen de los fondos.
                </li>
                <li>
                  Cuando se hayan completado los pasos anteriores se dará por registrada la operación, estableciéndose desde ese momento un
                  acuerdo de cambio de divisas entre el USUARIO e INSTAKASH.
                </li>
                <li>
                  Luego, el USUARIO deberá proceder a realizar la transferencia del monto objeto de cambio desde la Cuenta de Cargo, que
                  pertenezca a la persona o entidad que registra la operación y la cual se encuentra previamente registrada, hacia la cuenta
                  bancaria indicada de INSTAKASH, en un tiempo máximo de quince (15) minutos, contado a partir del momento del registro de
                  la operación. Solo durante el período de tiempo señalado, se mantendrá el acuerdo de cambio de dólares.
                </li>
                <li>
                ...
                <li>
                  Si el tipo de cambio varia drásticamente según criterio de INSTAKASH, se podrá anular la operación o realizarla a un nuevo
                  tipo de cambio si el usuario así lo prefiriese.
                </li>
                <li>
                ...
                <li>
                  Las operaciones ejecutadas vía transferencias interbancarias tendrán que considerar que el tiempo máximo de espera para la
                  llegada del fondo a la cuenta de INSTAKASH será las 17:30 horas del día del registro de la operación.
                </li>
                <li>
                  El USUARIO deberá entregar la constancia de la transferencia de los fondos a la cuenta bancaria indicada por INSTAKASH, en
                  el momento del registro de la operación y por el monto acordado.
                </li>
                <li>
                  El USUARIO deberá realizar la transferencia desde una cuenta personal o de la empresa que representa. INSTAKASH no acepta
                  depósitos en efectivo ni cheques, por lo que de detectarse alguna de estos casos la operación quedará anulada.
                </li>
                <li>
                  Es facultad de INSTAKASH informar aquellas operaciones que cumplan con la calidad de “operaciones sospechosas” de acuerdo
                  a la normativa que abarca únicamente la materia de prevención de lavado de activos y del financiamiento del terrorismo,
                  emitida por la SBS.
                </li>
                <li>
            ...
            <li id='#cupones' className='mt-2'>
              ...
              <p>
                ...
                adquiridos a través de nuestro whatsapp, redes sociales o promoción directa por parte de INSTAKASH a determinados usuarios.
              </p>
              <p>
                INSTAKASH establece los límites, condiciones, y detalles puntuales para el uso de sus cupones. Ciertos cupones de descuento
                son válidos únicamente para una determinada categoría, evento festivo, usuario frecuente, empresa, monto significativo,
                entre otros.
              </p>
              <p>
              ...
              <p>
                ...
                ejecute o se cancele dentro del plazo que tiene el usuario para transferir y completar sus datos de operación. INSTAKASH no
                se compromete en congelar mantener un tipo de cambio con cupón si la operación termina cancelándose por superar el límite de
              ...
              <p>
                El cupón INKAEMPRESAS es el cupón que ha sido creado para las empresas afiliadas a INSTAKASH. El cupón otorga puntos a favor
                de la tasa de cambio y debe ser activado por medio de Servicio al Cliente Instakash. Para ponerse en contacto encontrará un
                botón de Whatsapp en la parte inferior derecha de su pantalla acá en nuestro sitio web.
              </p>
          ...
          <ol className={styles.legalList}>
            ...
            <li>
              <p>
                ...
                ya existentes. El NIVEL JUNIOR será el rango estándar de inicio para cualquier USUARIO, en este nivel el USUARIO mantendrá y
                accederá a todos los beneficios y promociones que INSTAKASH realice en el mes, entre ellas se encuentra el cupón del mes
                (insertar link del cupón), los cupones supermontos y más.
                <br />
                <br />
                <b>SENIOR:</b> A partir de 5000$ a 50000$ en cambios acumulados. En este nivel se encuentran todos los usuarios registrados
                que superaron los 4999.99$ en cambios. El NIVEL SENIOR es el rango que sigue al JUNIOR, en este nivel el USUARIO mantendrá
                todos los beneficios del JUNIOR y adicionalmente recibirá acceso al uso de 1 cupón de descuento de 15 puntos para cualquier
                cambio que desee realizar sin límite de monto (exceptuando el monto mínimo establecido en nuestras políticas) y sin límite
                de uso. Válido por 30 días a partir del momento de la activación automática del rango de nivel. Una vez finalizado el
                periodo de los 30 días, el SISTEMA DE NIVELES detectará automáticamente en que rango comenzará el USUARIO en los siguientes
                30 días, según el monto acumulado en los cambios realizados durante este periodo.
                <br />
                <br />
                ...
                políticas) y sin límite de uso. Válido por 30 días a partir del momento de la activación automática del rango de nivel. Una
                vez finalizado el periodo de los 30 días, el SISTEMA DE NIVELES detectará automáticamente en que rango comenzará el USUARIO
                para los siguientes 30 días, según el monto acumulado en los cambios realizados durante este periodo.
              </p>
            </li>
          ...
          <ol className={styles.legalList}>
            ...
            <li>
              <p>
                ...
                consideradas transferencias interplaza. INSTAKASH no realiza transferencias hacia cuentas interplaza porque los bancos
                suelen agregar una alta comisión por transacción. Para evitar cualquier tipo de comisión bancaria interplaza, se recomienda
                utilizar los aplicativos móviles o páginas web de los bancos para efectuar las transferencias. Operaciones desde ventanilla
                (BCP o Interbank) o desde cuentas Interbank que no sean de Lima, podrían acarrear comisión.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              ...
              <p>
                INSTAKASH podría exonerar comisiones de transferencias interbancarias solo si la transacción de cambio supera los 2.000,00 $
                o su equivalente en soles. INSTAKASH se reserva la decisión final sobre este beneficio.
              </p>
            </li>
            ...
            <li>
              ...
              <p>
                ...
                ello debe tener en consideración que INSTAKASH tiene cuentas en Soles y en Dólares, y que una difiere de la otra. INSTAKASH
                no se responsabiliza de ninguna manera por la negligencia del usuario en este aspecto.
              </p>
              <p>
                ...
                minutos, siempre y cuando no se hayan establecido tiempos diferentes entre las partes o exista alguna dilación con el banco
              ...
              <p>
                ...
                importante destacar que los tiempos mencionados anteriormente se encuentran sujetos a variaciones causadas por
                verificaciones adicionales de seguridad que puedan ser necesarias, a la cuantía del monto requerido por el usuario y/o
                disponibilidad de las plataformas bancarias utilizadas. Estas condiciones son completamente ajenas a INSTAKASH y podrían
                retrasar el procesamiento y ejecución de la orden de compra.
              </p>
            </li>
            ...
            <li>
              ...
              <ul className='list-disc ml-6 mt-3'>
                ...
                <li>
                  Solicitar la devolución del monto, para lo cual INSTAKASH procederá a hacer la devolución del monto en la cuenta
                  registrada previamente; de modo que el USUARIO acepta asumir los costos (comisiones, impuestos y otros) en que incurra
                  INSTAKASH para tales efectos.
                </li>
              </ul>
              <p>
                Sin perjuicio de lo anteriormente mencionado, en caso de que INSTAKASH detecte alguna anomalía en el tipo de cambio o no
                pueda procesar la operación, por razones ajenas a la responsabilidad del USUARIO, tendrá la posibilidad de anular la
                operación de cambio de moneda procediendo con la devolución inmediata del monto abonado por el USUARIO. Dicha devolución
                será procesada mendiante el envío de un correo por parte del USUARIO indicando: nro. de operación, cuenta de orígen de los
                fondos y anexo de su voucher de transferencia. El mismo deberá ser enviado desde el correo registrado en plataforma por
                parte del USUARIO.
              </p>
              <p>
            ...
            <li>
              ...
              <p>
                INSTAKASH no se hace responsable ni ofrece devoluciones en los casos de un error en la información brindada por el USUARIO
                en los datos de transferencia.
              </p>
              <p>
            ...
            <li>
              <p>
                ...
                registrados. Por normativa de la Superintendencia Nacional de Aduanas y de Administración Tributaria (SUNAT), las
                operaciones de cambio de divisas están exentas del pago de IGV, es decir, no existe un cobro adicional por concepto de IGV.
              </p>
            </li>
            <h2>13. HORARIO DE ATENCIÓN:</h2>
            <li>
              <p>
                El horario de atención de INSTAKASH es de lunes a viernes de 9 am a 7 pm y sábados de 9 am a 2 pm, siempre y cuando sean
                días hábiles, es decir excluyendo feriados locales e internacionales. Por lo tanto, las operaciones y transferencias a ser
              ...
              <p>
                ...
                aceptada. Caso contrario, la misma será finalizada en el horario de apertura del siguiente dia útil, todo bajo las
                condiciones que INSTAKASH considere pertinentes.
              </p>
            </li>
            <h2>14. SEGURIDAD:</h2>
            <li>
              <p>
                ...
                EL USUARIO ha asignado en el momento del registro a través de LA PLimport Layout from '../src/components/layout/Layout';
                ATAFORMA de INSTAKASH. Por lo tanto, EL USUARIO es el único que conoce esta información. EL USUARIO no deberá revelar dicha
              ...
              <p>
                Todo tipo de información sensible entre su navegador e INSTAKASH se transfiere de forma encriptada utilizando (SSL), razón
                por la cual, deberá asegurarse de que su navegador reconozca y valide el certificado de www.instakash.net.
              </p>
            </li>
            ...
            <li>
              <p>
                ...
                ello, se prohíbe utilizar, codificar, copiar, distribuir, transmitir o comercializar los derechos involucrados sin el
              ...
              <p>
                ...
                siendo considerado una autorización ni licencia para utilizar los servicios y contenidos con fines distintos a los
            ...
            <li>
              ...
              <p>
                TRANSFERENCIA INTERBANCARIA: Cuando las trasferencias son entre cuentas de bancos locales distintas a las que tiene
                INSTAKASH.
              </p>
              <p>
              ...
              <p>
                TRANSFERENCIA INMEDIATA: Transferencia interbancarias que se pueden ejecutar en un aproximado de quince (15) minutos, donde
                la entidad financiera establecerá una comisión por dicho servicio que EL USUARIO tendrá que asumir
              </p>
            </li>
            <h2>18. ACUERDO COMPLETO</h2>
            <li>
              <p>
                Este contrato y cualquier documento expresamente mencionado en él, constituye el acuerdo entero entre EL USUARIO e INSTAKASH
                y sustituye cualquier discusión, correspondencia, acuerdos o entendimientos anteriores entre nosotros.
              </p>
              <p>
