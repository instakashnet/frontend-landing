        ...
        <div className='section-wrapper container px-3'>
          ...
          <ol className={styles.legalList}>
            <li>
              ...
              <p>
                Asimismo, INSTAKASH es un proveedor del servicio de cambio de divisas en el Perú, debidamente registrada y autorizada ante la Superintendencia de Banca, Seguros y
                AFP (en adelante, “SBS”) a través de Resolución N° 05939-2019-SBS.
              </p>
            </li>
            <li>
              <h3>2. PLATAFORMA</h3>
            ...
            <li>
              ...
              <p>
                ...
                que forman parte del contenido y servicios, pertenecen a INSTAKASH. En base a ello, se prohíbe utilizar, codificar, copiar, distribuir, transmitir o comercializar
          ...
          <ol className={styles.legalList}>
            <li>
              ...
              <p>
                El USUARIO, al hacer uso de los servicios brindados por INSTAKASH se compromete a mantener actualizados los datos brindados, o actualizarlos cuando ello se
                requiera.
              </p>
              <p>
            ...
            <li>
              ...
              <p>
                En caso se detecten cuentas duplicadas, la Empresa se reserva el derecho a cerrar o fusionar las mismas, sin necesidad de dar previo aviso al titular de las
                cuentas.
              </p>
            </li>
            <li>
              ...
              <p>
                INSTAKASH no será responsable por las comisiones cobradas por las entidades financieras por concepto de transferencia inmediata o transferencia regular, en el
                momento de la transferencia a cuentas de INSTAKASH.
              </p>
              ...
              <p>
                INSTAKASH no será responsable de errores, gastos, comisiones o tiempos incurridos debidos a errores del USUARIO o de los bancos donde este transfiera a otra cuenta
                de la especificada por INSTAKASH.
              </p>
          ...
          <ol className={styles.legalList}>
            ...
            <li>
              <p>
                INSTAKASH podrá ejercer las acciones que crea pertinentes para verificar la autenticidad de su identidad, pudiendo solicitar información adicional necesaria a fin
                de recabar la documentación correspondiente para dicho fin; de igual manera INSTAKASH se reserva el derecho de solicitar información a las entidades del Estado y/o
          ...
          <ol className={styles.legalList}>
            <li>
              ...
              <ul className='list-disc pl-6'>
                ...
                <li>
                  El USUARIO está obligado a indicar el origen de los fondos en base a la normativa vigente de prevención de lavado de activos y financiamiento de terrorismo, y
                  esta indicación tendrá validez de una declaración jurada.
                </li>
                <li>
            ...
            <li>
              <p>
                ...
                siempre y cuando hayan sido recibidas antes de las 19:00 horas de un día útil. Si INSTAKASH recibiera los fondos pasada dicha hora, la orden de compra será
                completada al día hábil siguiente. Por otro lado, las órdenes de compra colocadas durante un día no hábil también serán procesadas al siguiente día útil.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                ...
                que los fondos estén disponibles al titular de la cuenta de destino. Asimismo, es importante destacar que los tiempos mencionados anteriormente se encuentran
                sujetos a variaciones causadas por verificaciones adicionales de seguridad que puedan ser necesarias, a la cuantía del monto requerido por el usuario y/o
                disponibilidad de las plataformas bancarias utilizadas. Estas condiciones son completamente ajenas a INSTAKASH y podrían retrasar el procesamiento y ejecución de la
                orden de compra.
              </p>
            </li>
