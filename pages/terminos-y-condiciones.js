        ...
        <div className="section-wrapper container px-3 pt-12">
          ...
          <ol className={styles.legalList}>
            <li>
              ...
              <p>
                INSTAKASH es un proveedor del servicio de cambio de divisas en el Perú, debidamente registrada y autorizada ante la Superintendencia de Banca, Seguros y AFP (en
                adelante, “SBS”) a través de Resolución N° 05939-2019-SBS.
              </p>
            ...
            <li>
              ...
              <p>INSTAKASH se reserva el derecho de rechazar la apertura de cuentas respecto a personas cuya cuenta previamente haya sido dada de baja o suspendida”.</p>
              <p>
            ...
            <li>
              ...
              <p>
                En caso de que EL USUARIO no tenga cuentas bancarias en Lima y opere con transferencia interplaza, INSTAKASH deducirá del monto a enviar los costos bancarios
          ...
          <ol className={styles.legalList}>
            ...
            <li>
              ...
              <p>
                ...
                INSTAKASH son montos exactos y finales. Por ende, en caso INSTAKASH transfiera a favor del USUARIO un monto superior al acordado, el USUARIO se obliga a devolver
            ...
            <li>
              ...
              <p>TRANSFERENCIA INTERBANCARIA: Cuando las trasferencias son entre cuentas de bancos locales distintas a las que tiene INSTAKASH.</p>
              <p>
                TRANSFERENCIA INTERPLAZA: en el caso que el USUARIO no tenga cuentas en Lima INSTAKASH deducirá del monto a enviar como resultado de la operación los costos
                bancarios asociados al envió de dinero a otra plaza.
              </p>
              <p>
                TRANSFERENCIA INMEDIATA: Transferencia interbancarias que se pueden ejecutar en un aproximado de quince (15) minutos, donde la entidad financiera establecerá una
